...
public class RobotState {
  ...
  public void addVisionMeasurement(
      ...
      Rotation3d cameraAngleRelativeToTheRobot) {

    // So apparently we have to convert the robot relative standard deviations to field relative
    // standard deviations.
    ...
    Rotation2d cameraAngleRelativeToTheRobotButItIsARotation2dNow =
        new Rotation2d(cameraAngleRelativeToTheRobot.getX(), cameraAngleRelativeToTheRobot.getY());
    ...
    Matrix<N3, N1> fieldRelativeVisionStdDevs =
        VecBuilder.fill(fieldXStdDev, fieldYStdDev, visionStdDevs.get(2, 0));
